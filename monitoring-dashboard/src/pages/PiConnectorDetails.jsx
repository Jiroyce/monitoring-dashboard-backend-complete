...
const PiGatewayDetails = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const metricsData = await api.getConnectorMetrics('pi-connector', timeRange);
      setData(metricsData);
    } catch (error) {
  ...
  if (loading && !data) {
    return <LoadingSpinner message="Loading Pi-Connector metrics..." />;
  }
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">🔌 Pi-Connector Details</h1>
