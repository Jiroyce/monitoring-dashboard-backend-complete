...
import { adaptConnectorDetails } from '../utils/dataAdapter';
...
export const ConnectorDetails = ({ connectorName }) => {
  ...
  // Adapter les données du backend pour ce connecteur
  const details = rawData ? adaptConnectorDetails(rawData, connectorName) : null;
